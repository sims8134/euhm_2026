...
export const metadata: Metadata = {
  metadataBase: new URL("https://euhm.fr"),
  verification: {
  ...
  description:
    "Conseils bien-être, sport, alimentation, psychologie et écologie pour devenir une meilleure version de vous-même.",
  keywords: [
    "bien-être",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/img/og-image.jpg", // Assure-toi que l'image est bien dans public/og-image.jpg
        width: 1200,
        height: 630,
